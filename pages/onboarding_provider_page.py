...
class OnboardingProvider(BasePage):
    ...
    EMAIL_FIELD = (By.XPATH, "//div/input[@id='email']")
    PASSWORD_FIELD = (By.XPATH, "//div/input[@id='password']")
    CONFIRM_PASSWORD_FIELD = (By.XPATH, "//div/input[@id='confirmPassword']") #//form/child::div[3]/input[@id='confirmPassword']
   ...
   # Scenario: Enter the credentials to create the account
    ...
    def check_the_current_url(self, url):
        actual_url = "https://staging.counsl.dev/provider/signup"
...
#     #     actual_url = "https://staging.counsl.dev/provider/create-company/address"
#     #     assert url == actual_url, f'Error, the message is not in actual message, {actual_url}'
#
...
#         actual_url = "https://staging.counsl.dev/provider/create-company/personal-profile"
#         assert url == actual_url, f'Error, the message is not in actual message, {actual_url}'
#
...
#         actual_url = "https://staging.counsl.dev/provider/become-member"
#         assert url == actual_url, f'Error, the message is not in actual message, {actual_url}'
#
...
#         actual_url = "https://staging.counsl.dev/provider/become-member/success"
#         assert url == actual_url, f'Error, the message is not in actual message, {actual_url}'
#
